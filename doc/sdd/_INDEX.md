...
| 118 | 2026-06-22 | [WKH-SEC-02c] RLS Postgres-level en `registries` y `kite_schema_transforms` — ENABLE ROW LEVEL SECURITY en 2 tablas con owner_ref (spinoff de WKH-SEC-02) | security | QUALITY | in progress | feat/118-wkh-sec-02c-rls-registries ([work-item.md](118-wkh-sec-02c-rls-registries/work-item.md)) |
| 119 | 2026-06-22 | [WKH-SEC-02b] Validar `p_owner_ref` dentro de `increment_a2a_key_spend` — Ownership Guard DB-level en RPC fundacional de débito | security | QUALITY | in progress | feat/119-wkh-sec-02b-owner-ref-rpc ([work-item.md](119-wkh-sec-02b-owner-ref-rpc/work-item.md)) |
