...
| 080 | 2026-05-03 | [WKH-88] Bearer rotation refinements — HTTP method gate + JSDoc + KV mutex + tests | hardening | FAST+AR | in progress | feat/080-wkh-88-bearer-rotation-refinements ([work-item.md](080-wkh-88-bearer-rotation-refinements/work-item.md)) |
