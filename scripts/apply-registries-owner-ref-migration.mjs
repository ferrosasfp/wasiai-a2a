...
const migrationPath = '/home/ferdev/.openclaw/workspace/wasiai-a2a/supabase/migrations/20260427210000_registries_owner_ref.sql';
...
console.log('\nMigration applied. Verify with: SELECT column_name FROM information_schema.columns WHERE table_name = \'registries\' AND column_name = \'owner_ref\';');
