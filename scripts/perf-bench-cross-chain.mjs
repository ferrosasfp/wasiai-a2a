#!/usr/bin/env node
/**
 * Performance benchmark cross-chain — 5 runs.
 * Cada run hace /compose con 3 agents (1 Kite tx + 3 Fuji txs = 4 on-chain).
 * Costo estimado por run: ~$0.061 USDC.
 */
...
console.log('═══════════════════════════════════════════════════════════════');
console.log(`  Performance Benchmark cross-chain — ${RUNS} runs`);
console.log('═══════════════════════════════════════════════════════════════');
