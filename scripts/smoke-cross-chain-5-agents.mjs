#!/usr/bin/env node
/**
 * Smoke E2E TRUE cross-chain con 5 agentes (cap del pipeline).
 * Validar que el sistema aguanta el max de steps con downstream Fuji activo.
 */
...
console.log('═══════════════════════════════════════════════════════════════');
console.log('  Smoke E2E cross-chain — 5 AGENTS (pipeline cap)');
console.log('═══════════════════════════════════════════════════════════════');
console.log(`  Operator: ${operator.address}`);
console.log(`  Pipeline: ${PIPELINE.map(s => s.agent).join(' → ')}`);
console.log();

const probe = await fetch(`${A2A_URL}/compose`, {
  method: 'POST',
