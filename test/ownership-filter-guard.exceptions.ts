...
export const OWNERSHIP_FILTER_EXCEPTIONS: OwnershipFilterException[] = [
  ...
  // ── catalogo-publico (9) ────────────────────────────────────────────────
  {
    ...
    reason:
      ...
      'El resultado es server-side exclusivo y nunca entra a un shape público (docblock :428-447).',
  },
  {
    file: 'src/services/agent.ts',
    line: 589,
    ...
    reason:
      ...
      ':585 lo dice: "NO filtra por owner — es la vista pública descubrible".',
  },
  {
    file: 'src/services/agent.ts',
    line: 629,
  ...
  // ── chequeo-en-js (3) ───────────────────────────────────────────────────
  {
    ...
    reason:
      ...
      'de "no es tuyo". El dueño se compara en JS en :715 (update) y :890 (delete), que lanzan ' +
      'OwnershipMismatchError. En :529 se usa como pre-check de colisión de slug, donde no hay ' +
