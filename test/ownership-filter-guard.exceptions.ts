...
export const OWNERSHIP_FILTER_EXCEPTIONS: OwnershipFilterException[] = [
  ...
  // ── catalogo-publico (9) ────────────────────────────────────────────────
  {
    ...
    reason:
      ...
      'El resultado es server-side exclusivo y nunca entra a un shape público (docblock :330-335).',
  },
  {
    file: 'src/services/agent.ts',
    line: 454,
    ...
    reason:
      ...
      ':450 lo dice: "NO filtra por owner — es la vista pública descubrible".',
  },
  {
    file: 'src/services/agent.ts',
    line: 494,
  ...
  // ── admin-cross-tenant (12) ─────────────────────────────────────────────
  {
    ...
    reason:
      ...
      'PRIVILEGIO gateada SÓLO por requireAdminToken". Ruta src/routes/dashboard.ts:477.',
  },
  {
    file: 'src/services/arbiter.ts',
    line: 1237,
  ...
  },
  {
    ...
    reason:
      ...
      'dashboard.ts:424, gate requireAdminToken: 503 en producción si DASHBOARD_ADMIN_TOKEN no ' +
  ...
  },
  {
    ...
    category: 'admin-cross-tenant',
    reason:
      'readLeasedRow(intentId): el intent lo elige el operador del panel. Rutas dashboard.ts:680 ' +
      'y :742, gate requireAdminTokenStrict (fail-closed en dev Y prod).',
  },
  {
    file: 'src/services/reconciliation.ts',
    line: 614,
  ...
  },
  {
    ...
    category: 'admin-cross-tenant',
    reason:
      'resolveIntent(intentId): el intent lo elige el operador del panel. Ruta dashboard.ts:630, ' +
  ...
  },
  {
    ...
    category: 'admin-cross-tenant',
    reason:
      'lastCrossChainSettle: indicador de vida del rail cross-chain. Ruta dashboard.ts:390, gate ' +
      'requireAdminTokenForTrace, que es fail-closed en dev Y prod porque el payload trae ' +
      'owner_ref, montos y tx hashes de TODOS los owners (docblock dashboard.ts:300-309).',
  },
  {
    file: 'src/services/trace.ts',
    line: 523,
