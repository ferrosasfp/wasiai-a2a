...
vi.mock('../adapters/registry.js', () => ({
  getPaymentAdapter: vi.fn(() => ({
    ...
    settle: vi.fn(),
    verify: vi.fn(),
    quote: vi.fn().mockResolvedValue({ amountWei: '1000000', token: { symbol: 'PYUSD', address: '0x0', decimals: 6 }, facilitatorUrl: '' }),
    sign: vi.fn(),
  })),
  getChainConfig: vi.fn(() => ({ name: 'kite-ozone-testnet', chainId: 2368, explorerUrl: 'https://explorer.test' })),
