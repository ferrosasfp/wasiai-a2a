...
import { KiteOzonePaymentAdapter, _resetWalletClient } from '../../adapters/kite-ozone/payment.js'
...
describe('KiteOzonePaymentAdapter', () => {
  ...
  it('settle() returns SettleResult shape', async () => {
    ...
    const result = await adapter.settle({
      authorization: { from: '0x1', to: '0x2', value: '1', validAfter: '0', validBefore: '99', nonce: '0x3' },
      signature: '0xSIG',
