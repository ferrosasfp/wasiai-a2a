...
import { CircuitBreaker, CircuitOpenError, getRegistryCircuitBreaker } from './circuit-breaker.js'
...
describe('CircuitBreaker', () => {
  ...
  function makeCB(overrides: Partial<{ failureThreshold: number; windowMs: number; cooldownMs: number }> = {}) {
